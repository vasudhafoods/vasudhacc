...
export default function ForgotPasswordPage() {
  return <main className="grid min-h-screen place-items-center bg-[#f5f7f6] px-5 py-10">
    <section className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-7 shadow-[0_18px_50px_rgba(15,23,42,.08)]">
      ...
      <p className="mt-2 text-sm leading-6 text-slate-500">Warehouse accounts are managed by the Vasudha administrator. Ask an administrator to reset or replace your temporary password.</p>
      <ol className="mt-5 space-y-3 text-sm text-slate-600">
        ...
        <li className="flex gap-3"><span className="grid size-6 shrink-0 place-items-center rounded-full bg-emerald-50 text-xs font-semibold text-emerald-700">2</span><span>Ask them to issue a new warehouse password for your username.</span></li>
